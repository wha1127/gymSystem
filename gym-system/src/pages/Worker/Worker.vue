<template>
  <div id="worker-app">
    ...
    <el-container class="all-content">
        ...
        <div class="content">
          <div class="content-form">
            ...
            <p><span class="el-span4">账号状态:</span>
              <el-select v-model="value" placeholder="启用">
              <el-option
                class="el-option"
            ...
            <div><span>账号权限:</span>
              <div class="worker-power">
                <el-input class="el-input2" placeholder="输入选项名称"  v-model="filterText" empty-text></el-input>
                <el-tree
                  class="filter-tree"
                  :data="data"
                  show-checkbox
                  node-key="id"
                  :default-expand-keys="[2.3]"
      ...
      <el-footer>
        <div class="content">
          <el-button type="primary" @click="postMessage">保存</el-button>
